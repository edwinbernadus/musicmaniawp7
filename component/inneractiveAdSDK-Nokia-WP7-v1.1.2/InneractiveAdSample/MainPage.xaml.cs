...
namespace InneractiveAdSample
{
    ...
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        {
            InneractiveXamlAd.DefaultAdReceived +=InneractiveXamlAd_DefaultAdReceived;
            InneractiveXamlAd.AdClicked+= InneractiveXamlAd_AdClicked;
            InneractiveXamlAd.AdReceived+= InneractiveXamlAd_AdReceived;
            
            //DefaultAdReceived="InneractiveXamlAd_DefaultAdReceived" 
            //AdClicked="InneractiveXamlAd_AdClicked" 
            //AdReceived="InneractiveXamlAd_AdReceived"
        }
        private void InneractiveXamlAd_DefaultAdReceived(object sender)
        {
            MessageBox.Show("Default ad received");
        }
        ...
        private void InneractiveXamlAd_AdReceived(object sender)
        {
            MessageBox.Show("Ad received");
        }
    }
