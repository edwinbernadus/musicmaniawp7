    ...
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            try
            {
                ...
                FlurryWP7SDK.Api.StartSession(ParameterRepository.flurryId);
            }
        ...
        {
            //MainRepository.CopyMusicHubAction = null;
        ...
        public static async Task FirstLoadLogic()
        {
            ...
            var isEnableToCopy = GlobalManager.IsEnableCopyToMusicHub;
